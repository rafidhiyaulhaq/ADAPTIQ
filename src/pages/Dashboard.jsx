              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  ...
                  <Card key={index} className="relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-b from-blue-50 to-transparent rounded-full -mr-16 -mt-16" />
                    <CardContent className="p-6">
                      <div className="flex justify-between items-start">
                        ...
                        <div className="p-3 bg-blue-50 rounded-lg">
                          <stat.icon className="w-6 h-6 text-[#1428A0]" />
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                    ...
                    <div className="h-[300px]">
                      <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={[
                          ...
                          { skill: 'Algorithm Design', level: 70 }
                        ]}>
                          <CartesianGrid strokeDasharray="3 3" />
                          <XAxis dataKey="skill" />
                          <YAxis />
                    ...
                    {[
                      {
                        ...
                        description: "You learn best through diagrams and visual content"
                      },
                      {
                        title: "Peak Performance",
                        value: "Morning Sessions",
                        description: "Your focus is highest between 9 AM - 11 AM"
                      },
                      {
                        title: "Next Steps",
                      ...
                      <div key={index} className="space-y-2">
                        <h4 className="text-sm text-gray-500">{insight.title}</h4>
